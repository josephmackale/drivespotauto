            {{-- LEFT PANEL --}}
            <div class="bg-gray-100 p-6 lg:col-span-1 min-w-0">
                <div>
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">
                        ...
                        <div class="relative min-w-0" x-data="{ open: false }">
                            ...
                            <span class="absolute left-4 top-4 w-6 h-6 rounded-full bg-gray-200 text-gray-500 text-xs font-bold flex items-center justify-center z-10">
                                1
                            </span>
                            ...
                            <button
                                type="button"
                                @click="open = !open"
                                class="w-full min-h-[48px] border border-gray-300 bg-white pl-12 pr-10 text-left text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
                                <span x-show="!selectedMakeLabel" class="block py-2 pr-6">
                                    Select make
                                </span>

                                <span
                                    x-show="selectedMakeLabel"
                                    class="block py-2 pr-6 truncate"
                                    x-text="selectedMakeLabel"
                                ></span>
                            </button>

                            <span class="absolute right-4 top-4 text-gray-500 pointer-events-none">
                                    ...
                                    <template x-for="make in makes" :key="make.id">
                                        <button
                                            ...
                                            @click="
                                                ...
                                                onMakeChange();
                                            "
                                            class="w-full text-left px-4 py-2 border-b border-gray-100 hover:bg-blue-50"
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <button
                                ...
                                class="w-full min-h-[48px] border border-gray-300 bg-white pl-12 pr-10 text-left text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-400"
                            >
                                <span x-show="!selectedGenerationLabel" class="block py-2">
                                    <span x-text="loadingModels ? 'Loading models...' : 'Select model'"></span>
                                </span>

                                <span x-show="selectedGenerationLabel" class="block py-2 pr-6" x-text="selectedGenerationLabel"></span>
                            </button>
                            ...
                            >
                                <div class="sticky top-0 z-10 bg-white p-3 border-b border-gray-200">
                                    <input
                                        ...
                                        class="w-full h-10 border border-gray-300 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    >
                                </div>
                                    ...
                                    <template x-for="model in filteredModels()" :key="model.id">
                                        <div class="border-b border-gray-100">
                                            <button
                                                ...
                                                class="w-full flex items-center justify-between px-4 py-2 text-left hover:bg-blue-50"
                        ...
                        <div class="relative min-w-0" x-data="{ open: false }">
                            ...
                            <button
                                ...
                                class="w-full min-h-[48px] border border-gray-300 bg-white pl-12 pr-10 text-left text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-400"
                            >
                                <span x-show="!selectedEngineLabel" class="block py-2 pr-6">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('shop') }}" class="text-sm uppercase text-blue-600 hover:underline">
